...
<FRAMESET border=0 frameSpacing=0 rows=45,* frameBorder=NO cols=*>
    ...
    <FRAMESET id=info_show_frame border=0 frameSpacing=0 rows=* frameBorder=NO cols=196,12,*>
        <FRAME name=leftFrame src="./?go=welcome&do=left" scrolling=yes>
        <FRAME name=midFrame src="./?go=welcome&do=middle" frameBorder=0 noResize scrolling=no>
        <FRAME name=frmView id=frmView src="./?go=welcome&do=right">
    </FRAMESET>
</FRAMESET>
<noframes></noframes>
</HTML>
