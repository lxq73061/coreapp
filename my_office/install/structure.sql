...
CREATE TABLE IF NOT EXISTS `ecm_book` (
...
CREATE TABLE IF NOT EXISTS `ecm_channel` (
...
CREATE TABLE IF NOT EXISTS `ecm_diary` (
  ...
  `update_date` date DEFAULT NULL COMMENT '修改日期',
  `update_time` time DEFAULT NULL COMMENT '修改时间',
  `mood` varchar(10) NOT NULL COMMENT '心情',
  `weather` varchar(10) NOT NULL COMMENT '天气',
...
CREATE TABLE IF NOT EXISTS `ecm_doc` (
...
CREATE TABLE IF NOT EXISTS `ecm_site` (
...
CREATE TABLE IF NOT EXISTS `ecm_user` (
