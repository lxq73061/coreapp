...
/*FCKConfig.ToolbarSets["myset"] = [	
	['Undo','Redo','-''Cut','Copy','Paste','PasteText','PasteWord','Find'],
	['站内资料','Image','Flash','Smiley','SpecialChar','Link','Unlink','Anchor','Table','Rule','PageBreak'],
	...
	['Source',-,'FitWindow','ShowBlocks','-','扩展编辑区域','减少','About']
];*/
FCKConfig.ToolbarSets["Default"] = [	
	['Undo','Redo','-','Cut','Copy','Paste','PasteText','PasteWord','Find'],
	['Image','Flash','Smiley','SpecialChar','Link','Unlink','Anchor','Table','Rule','PageBreak'],
	['RemoveFormat','-','Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','OrderedList','UnorderedList','-','Outdent','Indent'],
	['FontFormat','FontName','FontSize','TextColor','BGColor'],
...
FCKConfig.FontNames	= "宋体;黑体;隶书;楷体_GB2312;" + FCKConfig.FontNames ;	
